  ...
  <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 lg:py-24 overflow-hidden">
    <div className="max-w-xl space-y-6 z-10">
      ...
      <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
        Join thousands of programmers solving challenging problems, competing in
        contests, and climbing the leaderboard.
      </p>
      <GradientButton className="px-4 py-6">Start solving now</GradientButton>
    </div>
